        ...
        if (erfolg) {
          ...
          if (selected) {
            await notifyVerein(
              ...
              `${nextOnList.name || nextOnList.freiwilliger_name} ist automatisch von der Warteliste nachgerückt.`,
              "warteliste"
            );
          }
        } else {
              ...
              for (const t of abgesagt) {
                ...
                if (bews)
                  for (const b of bews) {
                    ...
                    if (error) {
                      console.log("termin_abgesagt notification failed:", error);
                    }
                  }
                await supabase
                  .from("bewerbungen")
                ...
                if (original && original.datum !== t.datum) {
                  ...
                  if (bews)
                    for (const b of bews) {
                      ...
                      if (error) {
                        console.log("termin_geaendert notification failed:", error);
                      }
                    }
                }
              }

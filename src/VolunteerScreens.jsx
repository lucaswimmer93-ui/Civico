        ...
        {activeTab === "benachrichtigungen" && (
          <div>
              ...
              {[
                {
                  ...
                  label: "🙌 Einsatz-Erinnerungen",
                  sub: "24h vorher und 2–3 Stunden vorher",
                },
                {
                  key: "neue_stellen",
                  label: "🌱 Neue passende Einsätze",
                  sub: "Nur in gefolgten Vereinen & Kategorien",
                },
                {
                  key: "freie_plaetze",
                  label: "🔥 Fast voll / Platz frei",
                  sub: "Nur bei gefolgten Vereinen & Kategorien",
                },
              ].map((item) => (
                <div
                  key={item.key}
            ...
            >
              ...
              >
                SO KLINGEN DIE BENACHRICHTIGUNGEN
              </div>
              {[
                {
                  title: "24h vorher",
                  text: "Morgen ist dein Einsatz 🙌 Danke, dass du dabei bist – wir freuen uns auf dich.",
                },
                {
                  title: "2–3 Stunden vorher",
                  text: "Heute geht’s los 🙌 Wir freuen uns auf dich – bis später!",
                },
                {
                  title: "Wenn fast voll",
                  text: "Nur noch 1 Platz frei für Sonntag – willst du noch dabei sein?",
                },
                {
                  title: "Wenn jemand nicht erscheint",
                  text: "Schade, dass du nicht dabei sein konntest. Möchtest du beim nächsten Einsatz wieder mitmachen?",
                },
                {
                  title: "Nach dem Event",
                  text: "Danke für deinen Einsatz 🙌 Es hat richtig Spaß gemacht, dass du dabei warst.",
                },
              ].map((item) => (
                <div
                  key={item.title}
